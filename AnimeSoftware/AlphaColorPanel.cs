...
namespace Opulos.Core.UI
{
    public class AlphaColorPanel : Panel
    {
        ...
        {
            AutoSize = true, Minimum = 0, Maximum = 255, DecimalPlaces = 0, Increment = 1, Value = 255,
            Anchor = AnchorStyles.Top
        };

        private TrackBar trackBar = new TrackBar2
        {
            Minimum = 0, Maximum = 255, TickFrequency = 5, TickStyle = TickStyle.None,
            Orientation = Orientation.Horizontal, Value = 255, Anchor = AnchorStyles.Left | AnchorStyles.Right
        };

        private Color[] colors = new Color[]
            {Color.White, Color.Black, Color.Green, Color.Blue, Color.Red, Color.Yellow};
        ...
        public AlphaColorPanel() : base()
        {
            ...
            var p = new TableLayoutPanel {Dock = DockStyle.Bottom};
            p.AutoSize = true;
        ...
        {
            var w = SwatchSize * Cols;
            var h = SwatchSize * ((Colors.Length - 1) / Cols + 1);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var rows = (Colors.Length - 1) / Cols + 1;
            var r1 = Width / Cols;
            var r2 = Height / Cols;
            ...
            var offsetX = (Width - r * Cols) / 2;
            var offsetY = (Height - Math.Max(nudAlpha.Height, trackBar.Height) - r * rows) / 2;
    ...
    internal class TrackBar2 : TrackBar
    {
        public TrackBar2() : base()
        {
            AutoSize = false;
            var r = GetThumbRect(this);
